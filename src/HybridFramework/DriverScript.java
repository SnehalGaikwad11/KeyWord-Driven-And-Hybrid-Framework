...
public class DriverScript 
{
	...
	public static Methods methodKeywords;
	...
	public static void main(String[] args) throws Exception 
	{
		...
		// This is the loop for reading the values of the column (Action Keyword) row by
		// row
		// It means this loop will execute all the steps mentioned for the test case in
		// Test Steps sheet
	...
	// As it is completely different set of logic, which revolves around the action
	// only, it makes sense to keep it separate from the main driver script
	// This is to execute test step (Methods)
	private static void execute_Actions() throws Exception
	{
		// Here we are instantiating a new object of class 'Methods'
		methodKeywords = new Methods();
		// This will load all the methods of the class 'Methods' in it.
		// It will be like array of method, use the break point here and do the watch
		method = methodKeywords.getClass().getMethods();
		// This is a loop which will run for the number of actions in the Methods Keyword
		// class
		// method variable contain all the method and method.length returns the total
		// number of methods
		for (int i = 0; i < method.length; i++) {
			// This is now comparing the method name with the Methods keywords value received
			// from the excel
			if (method[i].getName().equals(sActions)) 
			{ // In case of match found, it will execute the matched method
				method[i].invoke(methodKeywords);
